...
\begin{answer}[]
    \input{resposta02}
\end{answer}
\begin{lstlisting}[language=R, caption={Simulação de Monte Carlo para testar o intervalo de confiança aproximado obtido para o item (a), $g(\theta)=P_{\theta}(Z>1)$.},label={lst:a}]
set.seed(123)
...
\begin{lstlisting}[language=R, caption={Simulação de Monte Carlo para testar o intervalo de confiança aproximado obtido para o item (b), $g(\theta)=P_{\theta}(0.1<Z<1)$.},label={lst:b}]
set.seed(123)
...
\begin{lstlisting}[language=R, caption={Simulação de Monte Carlo para testar o intervalo de confiança aproximado obtido para o item (c), $g(\theta)=\mathrm{Var}\theta(Z)$},label={lst:c}]
set.seed(123)
