...
\begin{answer}[]
    \input{resposta02}
\end{answer}
\begin{lstlisting}[language=R, caption={"Simulação de Monte Carlo para testar o intervalo de confiança aproximado obtido para o item (a), $g(\theta)=P_{\theta}(Z>1)$.}]
set.seed(123)
...
\begin{lstlisting}[language=R, caption={Simulação de Monte Carlo para testar o intervalo de confiança aproximado obtido para o item (b), $g(\theta)=P_{\theta}(0.1<Z<1)$.}]
set.seed(123)
