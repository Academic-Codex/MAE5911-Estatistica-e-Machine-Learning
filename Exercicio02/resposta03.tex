...
Usando a mesma mudança de variável
\(y = (z-\mu)/\sigma\), \(z = \mu + \sigma y\), \(dz = \sigma dy\), temos
\[
  E_\theta(Z^2)
  = \int_{-\infty}^{\infty}
  (\mu + \sigma y)^{2}\,
...
\[
  \int_{-\infty}^{\infty}
  \frac{1}{\sqrt{2\pi}}e^{-y^{2}/2}\,dy = 1,\qquad
  \int_{-\infty}^{\infty}
  y\,\frac{1}{\sqrt{2\pi}}e^{-y^{2}/2}\,dy = 0,
\]
e, pela definição de variância da Normal padrão \(N(0,1)\),
\[
  \int_{-\infty}^{\infty}
  y^{2}\,\frac{1}{\sqrt{2\pi}}e^{-y^{2}/2}\,dy = 1.
\]
